...
export class Transformer {
     ...
     */
    generateRawMetricObjectsFromAzureRawMetricRecord(msg, selectStatsForMetricFn) {
     ...
     */
    prepareMetricObject(metricObject, format) {
        if (metricObject.metric_string)
            return metricObject; // do nothing
     ...
     */
    generateMetricObjectsFromAzureRawData(azureMetricArray, selectStatsForMetricFn, format) {
        let finalMetricArray = [];
